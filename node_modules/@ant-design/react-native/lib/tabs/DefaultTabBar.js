        ...
        _this.renderTab = function (tab, index, width, onLayoutHandler, styles, theme) {
            ...
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                    _reactNative.View,
                    { style: (0, _extends3['default'])((0, _extends3['default'])((0, _extends3['default'])({}, _reactNative.StyleSheet.flatten(styles.tab)), _this.props.tabStyle), { width: width }) },
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                ...
                function (styles, theme) {
                    var tabUnderlineStyle = (0, _extends3['default'])((0, _extends3['default'])({ position: 'absolute', bottom: 0 }, _reactNative.StyleSheet.flatten(styles.underline)), _reactNative.StyleSheet.flatten(tabBarUnderlineStyle));
                    ...
                    var underlineProps = {
                        style: (0, _extends3['default'])((0, _extends3['default'])({}, dynamicTabUnderline), tabUnderlineStyle)
                    };
                    return _react2['default'].createElement(
                        _reactNative.View,
                        ...
                        _react2['default'].createElement(
                            ...
                            _react2['default'].createElement(
                                _reactNative.View,
                                { style: [styles.tabs, (0, _extends3['default'])((0, _extends3['default'])({}, tabsContainerStyle), { backgroundColor: tabBarBackgroundColor })], onLayout: _this2.onTabContainerLayout },
