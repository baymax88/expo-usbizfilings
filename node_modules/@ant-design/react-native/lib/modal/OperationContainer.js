    ...
    (0, _createClass3['default'])(OperationContainer, [{
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                ...
                function (styles) {
                    return _react2['default'].createElement(_Modal2['default'], { operation: true, transparent: true, maskClosable: true, visible: _this2.state.visible, onClose: _this2.onClose, onAnimationEnd: onAnimationEnd, onRequestClose: _this2.onBackAndroid, style: styles.operationContainer, bodyStyle: styles.operationBody, footer: footer });
                }
            );
        }
    }]);
